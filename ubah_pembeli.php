...
{	
	...
	"UPDATE pembelli SET id_pmb='$id_pmb',nama_pmb='$nama_pmb',no_tlf='$no_tlf,alamat='$alamat' 
	WHERE id_pmb=$id");
...
$result = mysqli_query($conn, "SELECT * FROM pembelli WHERE id_pmb=$id");
...
<body>
	...
	<form name="update_user" method="post" action="ubah_pembeli.php">
		<table border="0">
			<tr> 
				<td>ID Pembeli</td>
