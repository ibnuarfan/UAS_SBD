...
{	
	...
	"UPDATE pembayarann SET id_bayar='$id_bayar',id_trs='$id_trs',tgl_bayar='$tgl_bayar'jml_bayar='$jml_bayar' 
	WHERE id_bayar=$id");
...
$result = mysqli_query($conn, "SELECT * FROM pembayarann WHERE id_bayar=$id");
...
<body>
	...
	<form name="update_user" method="post" action="ubah_pembayaran.php">
		<table border="0">
			<tr> 
				<td>ID Pembayaran</td>
